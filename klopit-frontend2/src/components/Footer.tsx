    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-social-links">
          <a
            href="https://www.instagram.com/klopit_seinajoki" 
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram"
          >
            {/* THIS IS THE VERIFIED, CORRECT INSTAGRAM ICON */}
          ...
          <a
            href="https://www.facebook.com/SJKKannattajat"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
          >
            {/* Facebook icon remains the same */}
